...
class MyTheme {
  ...
  static const Color accent_color = Color.fromRGBO(60, 169, 235, 1);
  static const Color accent_color_shadow =
      Color.fromRGBO(42, 118, 165, 1); // this color is a dropshadow of
  static Color soft_accent_color = Color.fromRGBO(254, 234, 209, 1);
  static Color splash_screen_color = Color.fromRGBO(
      60, 169, 235, 1); // if not sure , use the same color as accent color
