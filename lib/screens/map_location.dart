...
class MapLocation extends StatefulWidget {
  MapLocation({Key? key, this.address, this.isFromPage}) : super(key: key);
  var address;
  var isFromPage;
...
class MapLocationState extends State<MapLocation>
  ...
  static LatLng kInitialPosition =
      LatLng(-7.356200737918901, 109.90252074190711); // London , arbitary value
  ...
  void initState() {
    ...
    if (widget.address != null && widget.address.location_available) {
      setInitialLocation();
    } else {
  ...
  setDummyInitialLocation() {
    kInitialPosition = LatLng(
        -7.356200737918901, 109.90252074190711); // London , arbitary value
    setState(() {});
  }
  ...
  onTapPickHere(selectedPlace) async {
    ...
    if (widget.isFromPage != null && widget.isFromPage == "AddAddress") {
      _selectedLocation.add(selectedPlace.geometry.location.lat.toString());
      _selectedLocation.add(selectedPlace.geometry.location.lng.toString());
      _selectedLocation.add(selectedPlace.formattedAddress);
