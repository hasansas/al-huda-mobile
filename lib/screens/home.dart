              ...
              itemBuilder: (context, index) {
                return (index == homeData.featuredProductList.length)
                    ...
                    : MiniProductCard(
                        ...
                        sub_district: homeData
                            .featuredProductList[index].shops.sub_district,
                        rating:
                            homeData.featuredProductList[index].rating,
                        num_of_sale: homeData
                            .featuredProductList[index].sales,
                      );
              },
            ),
          ),
