        ...
        child: MasonryGridView.count(
          ...
          itemBuilder: (context, index) {
            ...
            return ProductCard(
                ...
                is_wholesale: false,
                sub_district: _auctionlProductItems[index].shops.sub_district,
                rating: _auctionlProductItems[index][index].rating,
                num_of_sale: _auctionlProductItems[index][index].sales,
